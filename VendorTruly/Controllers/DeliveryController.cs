...
namespace VendorTruly.Controllers
{
    ...
    {
        private string innerWebSite = "http://192.168.90.100/VendorTruly/";
        private string outerWebSite = "http://59.37.42.23/VendorTruly/";
        ...
        public JsonResult GetPOs(FormCollection fc)
        {
            ...
            return Json(new { suc = true, rows = result.OrderBy(r => r.poDate).OrderBy(r=>r.poNo).OrderBy(r=>r.poEntryId) });
